...
export default function login() {
  ...
  return (
    ...
    <div className="bg-gray-300 dark:bg-gray-700 p-8 max-w-md mx-auto rounded-lg transition-colors duration-300">
      ...
      <h1 className={`text-sm sm:text-2xl font-bold text-gray-800 dark:text-white mb-2`}>INICIA SESION</h1>
      <h2 className={`text-2xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4`}>Que bueno volver a verte<span className="text-blue-500">.</span></h2>
