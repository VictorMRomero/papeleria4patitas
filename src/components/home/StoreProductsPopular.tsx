...
import { getAllStoreProductsNewest} from '@/actions/store/get-stores'
import { ProductStore } from '@/interfaces'
import { ProductCarousel, Title } from '@/components'

export const StoreProductsPopular = () => {
  ...
  return (
    <div className="py-4">
      ...
      <ProductCarousel
        ...
        viewMoreLink={`/store/${selectedStore.id}/products/popular`}
        viewMoreText={`Ver todos los productos mas populares`}
      />
    </div>
  )
}